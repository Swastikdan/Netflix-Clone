...
function generateMovieData(movieId) {
  ...
  <img class="pl-20 bg-gray-800" src="${movieData.imagemain}" class=" h-[750px] w-full" alt="${movieData.title}" loading="${loading}" />
...
background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(53,50,50,0.8380602240896359) 71%,rgba(53,50,50,0.6380602240896359) 81%,rgba(53,50,50,0.3380602240896359) 95%, rgba(0,0,0,0) 100%);">
      <img width="400px" src="${movieData.imagetext}" alt="${movieData.title}" loading="${loading}"/>
      <div class="space-y-4">
          <span class="text-[28px] font-semibold">${movieData.title}</span> <br>
          <p class="text-[14px] font-medium text-gray-400">
              <span>${movieData.releseyear} &nbsp;|&nbsp;&nbsp;</span>
              <span class="ring-1 ring-gray-400 px-2 ">&nbsp;${movieData.maturityrating} </span>
      ...
      <div class="buttons text-[16px] flex space-x-10">
          <a href="#_" onclick="openSlide(${movieData.number})"
