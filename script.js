...
(document.getElementById("footer").innerHTML = g),
  fetch("/assets/movies-db.json")
    .then((e) => e.json())
    .then((e) => {
      c = e;
...
function C() {
  for (
    var e = document.getElementsByClassName("youtube-player"), i = 0;
    i < e.length;
    i++
  ) {
    ...
    (r.src = "//i.ytimg.com/vi/ID/hqdefault.jpg".replace("ID", n)),
      s.appendChild(r);
    var t = document.createElement("div");
    t.setAttribute("class", "play"),
      s.appendChild(t),
      (s.onclick = function () {
        E(this);
      }),
...
(document.getElementById("carasol-content-1").innerHTML = b),
  (document.getElementById("carasol-content-2").innerHTML = x),
  (document.getElementById("carasol-content-3").innerHTML = z),
  (document.getElementById("carasol-content-4").innerHTML = k),
...
class d extends HTMLElement {
  connectedCallback() {
    ...
    e.removeAttribute("href"),
      this.addEventListener("pointerover", d.warmConnections, {
        once: !0,
      }),
